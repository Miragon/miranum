package io.miragon.miranum.platform.connect.json.registry.application.service;

import io.miragon.miranum.platform.connect.json.registry.domain.Schema;
import io.miragon.miranum.platform.connect.json.registry.application.ports.in.ReadSchemaUseCase;
import io.miragon.miranum.platform.connect.json.registry.application.ports.in.SaveSchemaInCommand;
import io.miragon.miranum.platform.connect.json.registry.application.ports.in.SaveSchemaUseCase;
import io.miragon.miranum.platform.connect.json.registry.application.ports.out.LoadSchemaPort;
import io.miragon.miranum.platform.connect.json.registry.application.ports.out.SaveSchemaPort;
import io.miragon.miranum.platform.connect.shared.ObjectNotFoundException;
