package io.miragon.miranum.platform.connect.json.registry.registry.application.service;

import io.miragon.miranum.platform.connect.json.registry.registry.application.ports.in.ReadSchemaUseCase;
import io.miragon.miranum.platform.connect.json.registry.registry.application.ports.in.SaveSchemaInCommand;
import io.miragon.miranum.platform.connect.json.registry.registry.application.ports.in.SaveSchemaUseCase;
import io.miragon.miranum.platform.connect.json.registry.registry.application.ports.out.LoadSchemaPort;
import io.miragon.miranum.platform.connect.json.registry.registry.application.ports.out.SaveSchemaPort;
import io.miragon.miranum.platform.connect.json.registry.registry.domain.Schema;
import io.miragon.miranum.platform.connect.shared.shared.ObjectNotFoundException;
