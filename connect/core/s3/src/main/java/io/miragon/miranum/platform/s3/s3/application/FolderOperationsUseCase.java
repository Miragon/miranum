package io.miragon.miranum.platform.s3.s3.application;

import io.miragon.miranum.platform.s3.s3.application.port.in.FolderOperationsApi;
import io.miragon.miranum.platform.s3.s3.domain.model.FileSystemAccessException;
import io.miragon.miranum.platform.s3.s3.adapter.out.persistence.File;
import io.miragon.miranum.platform.s3.s3.application.port.out.FileRepository;
import io.miragon.miranum.platform.s3.s3.application.port.out.S3Repository;
import io.miragon.miranum.platform.s3.s3.domain.model.FilesInFolder;
