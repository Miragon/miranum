package io.miragon.miranum.connect.s3.application;

import io.minio.http.Method;
import io.miragon.miranum.connect.s3.adapter.out.persistence.File;
import io.miragon.miranum.connect.s3.application.port.in.FileOperationsApi;
import io.miragon.miranum.connect.s3.application.port.out.FileRepository;
import io.miragon.miranum.connect.s3.application.port.out.S3Repository;
import io.miragon.miranum.connect.s3.domain.model.*;
