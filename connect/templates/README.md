    ...
    <plugins>
        <plugin>
            ...
            <configuration>
                ...
                <platformSpecificCongig>
                    <c7>
                        <asyncBeforeDefaultValue>true</asyncBeforeDefaultValue>
...
| `platformSpecificCongig.c7.asyncBeforeDefaultValue` | **(optional)** | Set the default value for `asyncBefore` property                 | `true`, `false`           | `false`                                                          |
| `platformSpecificCongig.c7.asyncAfterDefaultValue`  | **(optional)** | Set the default value for `asyncAfter` property                  | `true`, `false`           | `false`                                                          |
