...
public class HexagonalArchitecture extends ArchitectureElement {
    ...
    public void check(JavaClasses classes) {
        ...
        this.applicationLayer.getIncomingPortsPackages().forEach(obj ->
                this.adapters.outgoingDoesNotDependOn(obj, classes));

        this.applicationLayer.getOutgoingPortsPackages().forEach(obj ->
                this.adapters.incomingDoesNotDependOn(obj, classes));
