package io.miragon.miranum.platform.engine.adapter.in.engine;

import io.miragon.miranum.platform.engine.application.port.in.process.UpdateProcessInstanceDescriptionUseCase;
import io.miragon.miranum.platform.engine.application.port.in.process.UpdateProcessInstanceStatusUseCase;
import io.miragon.miranum.platform.engine.application.port.in.processconfig.ProcessConfigQuery;
